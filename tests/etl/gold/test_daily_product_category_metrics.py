...
def test_get_daily_product_category(spark):
    ...
    wide_sales_test_data = [
        ('english_name_1', Decimal('10.00'), Decimal('20.00')),
        ('english_name_1', Decimal('16.00'), Decimal('26.00')),
        ('english_name_1', Decimal('10.00'), Decimal('20.00')),
        ('english_name_2', Decimal('20.00'), Decimal('40.00')),
        ('english_name_2', Decimal('60.00'), Decimal('80.00')),
    ]
